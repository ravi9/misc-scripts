...
# === CONFIGURATION ===
export OPENVINO_VERSION_MAJOR=2026.2.1
export OPENVINO_VERSION_FULL=2026.2.1.21919.ede283a88e3
...
# Download custom dependency installer only for Ubuntu 24.10, 25.04, 25.10
if [ "$OS_FULL" == "ubuntu24.10" ] || [ "$OS_FULL" == "ubuntu25.04" ] || [ "$OS_FULL" == "ubuntu25.10" ]; then
