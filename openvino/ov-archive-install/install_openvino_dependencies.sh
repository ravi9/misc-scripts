...
if [ "$os" == "auto" ] ; then
    ...
    case $os in
        ...
        raspbian12|debian12|ubuntu22.10:ubuntu23.04|ubuntu23.10|ubuntu24.04|ubuntu24.10|ubuntu25.04|ubuntu25.10) [ -z "$print" ] && echo "Detected OS: ${os}" ;;
...
if [ "$os" == "raspbian9" ] || [ "$os" == "debian9" ] ; then
    ...
    [ "$os" == "ubuntu22.10" ] || [ "$os" == "ubuntu23.04" ] || [ "$os" == "ubuntu24.04" ] || [ "$os" == "ubuntu24.10" ] ||
    ...
    elif [ "$os" == "ubuntu24.04" ] || [ "$os" == "ubuntu24.10" ] ; then
        pkgs_python+=(libpython3.12)
    elif [ "$os" == "ubuntu25.04" ] || [ "$os" == "ubuntu25.10" ] ; then
...
if [ "$os" == "debian9" ] || [ "$os" == "raspbian9" ] || [ "$os" == "ubuntu18.04" ] ||
   ...
   [ "$os" == "debian11" ] || [ "$os" == "raspbian11" ] || [ "$os" == "ubuntu21.10" ] || [ "$os" == "ubuntu22.04" ] ||
    [ "$os" == "debian12" ] || [ "$os" == "raspbian12" ] || [ "$os" == "ubuntu22.10" ] || [ "$os" == "ubuntu23.04" ] || [ "$os" == "ubuntu23.10" ] || [ "$os" == "ubuntu24.04" ] || [ "$os" == "ubuntu24.10" ] || [ "$os" == "ubuntu25.04" ] || [ "$os" == "ubuntu25.10" ] ; then
